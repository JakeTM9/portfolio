...
function App() {
  ...
  return (
    <div classNameName="App"> 
      <header classNameName="header">
        <a classNameName='link-selected' href="#"> Home </a>
        <a classNameName='link' href="#"> Page2 </a>
      </header>
      <section classNameName="section-1">
        <div>
          <p>test</p>
        </div>
      </section>
    ...
    <div className="App"> 
      <div id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div id="about" className="container-fluid">
          ...
          <br></br><button className="btn btn-default btn-lg bordered">Get in Touch</button>
        </div>
  ...
  /*
        ...
        <img src="/w3images/map.jpg" className="w3-image w3-greyscale-min" style="width:100%"></img>
